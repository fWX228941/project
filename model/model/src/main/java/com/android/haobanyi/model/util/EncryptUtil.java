...
/**
 * 加密工具类，参考：https://github.com/wswenyue
 *
 * @author fumin
 * @date 16/4/18
 * @version 1.0
...
public class EncryptUtil {
    ...
    /*
    * 参考文档：http://blog.csdn.net/geoffreyqh/article/details/6193746?locationNum=7
    *http://blog.csdn.net/xiaokui_wingfly/article/details/38045871?locationNum=5
    * */
...
//            return new BigInteger(1, md.digest()).toString(16);//就是这个函数是有问题的
...
/*            for (byte b : md.digest()) {
            ...
            return sb.toString();*/
            /*
            * 先使用下面这种方式，貌似可以哦！别人的代码真心很多坑，尤其是这种公共类，反正我是被坑了很多次了，不说了，先摸吧眼泪
            * */
    ...
    /*越改问题越多，我去*/
    public static String makeTestMD5(String password) {
        try {

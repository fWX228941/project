 ...
 * @创建日期：2016/05/13
 * @邮箱：466566941@qq.com
 * @当前文件描述：可以裁剪三种样式，分别是上中下
 * 使用说明：宽高定义的是300/100
 * 上：bitmapTransform(new CropTransformation(mContext, 300, 100, CropTransformation.CropType.TOP))
 * 中：bitmapTransform(new CropTransformation(mContext, 300, 100))
 * 下：bitmapTransform(new CropTransformation(mContext, 300, 100, CropTransformation.CropType.BOTTOM))
 *
 *
 */

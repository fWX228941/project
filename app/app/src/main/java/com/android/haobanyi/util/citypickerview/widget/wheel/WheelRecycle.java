...
public class WheelRecycle {
	...
	// Wheel view
	private com.android.haobanyi.util.citypickerview.widget.wheel.WheelView wheel;
	
	/**
	 * Constructor
	 * @param wheel the wheel view
	 */
	public WheelRecycle(com.android.haobanyi.util.citypickerview.widget.wheel.WheelView wheel) {
		this.wheel = wheel;
	}

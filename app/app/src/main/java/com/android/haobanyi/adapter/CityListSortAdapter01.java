...
/**
 * Created by fWX228941 on 2016/5/20.
 *
 * @作者: 付敏
 * @创建日期：2016/05/20
 * @邮箱：466566941@qq.com
 * @当前文件描述：重构前没有任何问题，我也是醉了
 */
public class CityListSortAdapter01 extends BaseAdapter implements SectionIndexer {
    private List<CitySortBean> list = null;
    private Context mContext;

    public CityListSortAdapter01(Context mContext, List<CitySortBean> list) {

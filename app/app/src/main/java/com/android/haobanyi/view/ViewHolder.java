 ...
 * https://github.com/canyinghao/CanAdapter
 */
public class ViewHolder implements View.OnClickListener,View.OnLongClickListener,CompoundButton.OnCheckedChangeListener{
    ...
    // 当吧监听器也看成对象的时候其实也没有什么了
    /*客户端需要在外部来实例化监听器对象，用来设置*/
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
        // 用户自己来实现操作  是正在的监听操作，只是里面又封装了一成，这样就是为了名字更清楚
        if(null != mOnItemListener){

            mOnItemListener.onItemChildCheckedChanged(compoundButton,mPosition,isChecked);
        }
    }
    ...
    /*子控件设置监听器*/
    /*事件，长按，触摸，点击*/
    public ViewHolder setItemChildClickListener(int viewId ,View.OnClickListener listener){
        View view = getView(viewId);
        view.setOnClickListener(listener);
        return this;
    }
    public ViewHolder setItemChildTouchListener(int viewId,
    ...
    public ViewHolder setItemChildLongClickListener(int viewId,

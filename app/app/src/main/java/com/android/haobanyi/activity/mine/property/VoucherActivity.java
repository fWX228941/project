 ...
 * @创建日期：2016/08/08
 * @邮箱：466566941@qq.com
 * @当前文件描述：我的代金券  ，参考设计StoreVoucherFragment
 * activity_my_voucher
 * item_my_voucher
 *  分为两个部分，其一是领取代金券，其二是我的代金券
 *  MyVoucherAdapter
 *
 */
public class VoucherActivity extends BaseActivity  implements BaseQuickAdapter.RequestLoadMoreListener,SwipeRefreshLayout.OnRefreshListener {
    ...
    MyVoucherAdapter adapter = new MyVoucherAdapter(null);
    ...
    private void loginForToken() {
        ...
        IntentUtil.gotoActivityForResult(VoucherActivity.this, LoginActivity.class, LOGIN_TO_VOUCHER);//跳转到登录界面
    }
    ...
    private void handleLogic() {
        ...
        if (isLogin){
            ...
            progressActivity.showEmpty("亲，暂时还没有登录，请先到用户设置的登录界面登录，然后才能查看我的代金券！");
        }
    ...
    private void getDataFromServer(final int currentPage,final boolean isRefreshOrFirstLoading) {
        ...
        this.appAction.getVoucherList(currentPage, PAGESIZE, new ActionCallbackListener<List<VoucherBean>>() {

            @Override
            public void onSuccess(List<VoucherBean> data) {
                ...
                if (totalCount == 0) {
                    progressActivity.showEmpty("我的代金券为空！");
                } else {
                        ...
                        if (!isRefreshOrFirstLoading) {
                            if (isListToBottom) {
                                ...
                                if (notLoadingView == null) {
                                    inflater = LayoutInflater.from(VoucherActivity.this);
    ...
    private void initAdapter(List<VoucherBean> listData) {
        adapter = new MyVoucherAdapter(listData);
    ...
    /*01.循环视图设置布局管理器*/
        mSuperRecyclerViewImg.setLayoutManager(new LinearLayoutManager(VoucherActivity.this));
        /*03.设置下拉刷新的监听器*/
    ...
    private void initTittleBar() {
        ...
        titleBar.addAction(new TitleBar.TextAction("领取代金券") {
            @Override
            public void performAction(View v) {
                // 跳转到领取代金券界面
                IntentUtil.gotoActivityWithoutData(VoucherActivity.this, GetVoucherActivity.class, false);
            }
        });
        ...
        titleBar.setLeftClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                VoucherActivity.this.overridePendingTransition(R.anim.exit_enter, R.anim.exit_exi);
            }
        });
        titleBar.setTitle("我的代金券");
